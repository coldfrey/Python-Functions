...
query = {
    'query': '*[_type == "product" || _type == "catalog" || _type == "country" || _type == "variant" || _type == "taxon" || _type == "taxonomy" || _type == "customer" || _type == "color" || _type == "size"]'
    
}

# Specific query to get the ids of every product in the dataset
# query = {
#     'query': '*[_type == "product"]'
# } 
